...
<div class="article-img-container">
  <Image src={fingerPaint} alt="Finger painting of finger span" width="750" loading="lazy" class="article__img"/>
</div>
...
<div class="article-img-container">
  <Image src={yggSchematics} alt="Schematics for the pcb" width="750" loading="lazy" class="article__img"/>
</div>
...
<div class="article-img-container">
  <Image src={yggConnections} alt="Connections for pcb" width="750" loading="lazy" class="article__img"/>
</div>

The 3d view of the same PCB, in Kicad:

<div class="article-img-container">
  <Image src={yggPcb} alt="3d view of pcb" width="750" loading="lazy" class="article__img"/>
</div>

And finally the physical PCB, ordered from JLCPCB, but there are many others out there as well:

<div class="article-img-container">
  <Image src={yggRealPcb} alt="Physical pcb" width="750" loading="lazy" class="article__img"/>
</div>
