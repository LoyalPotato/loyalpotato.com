...
<div class="project-img-container">
  <Image src={yggSchematics} alt="Schematics for the pcb" format="webp" loading="lazy" class="project__img"/>
</div>
...
<div class="project-img-container">
  <Image src={yggConnections} alt="Connections for pcb" format="webp" loading="lazy" class="project__img"/>
</div>

The 3d view of the same PCB, in Kicad:

<div class="project-img-container">
  <Image src={yggPcb} alt="3d view of pcb" format="webp" loading="lazy" class="project__img"/>
</div>

And finally the physical PCB, ordered from JLCPCB, but there are many others out there as well:

<div class="project-img-container">
  <Image src={yggRealPcb} alt="Physical pcb" format="webp" loading="lazy" class="project__img"/>
</div>
